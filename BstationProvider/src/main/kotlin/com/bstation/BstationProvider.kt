...
class BstationProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "search:shounen" to "Shounen",
        "search:magic" to "Magic",
        "search:historical" to "Historical",
        "search:martial arts" to "Martial Arts",
        "search:mecha" to "Mecha",
        "search:game" to "Game",
        "search:kids" to "Kids",
        "search:idol" to "Idol",
        "search:crime" to "Crime",
