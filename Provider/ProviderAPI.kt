...
object ProviderAPI {
    ...
    suspend fun load(provider: BaseProvider, url: String): LoadResponse {
        return when (provider.providerId) {
    ...
    private suspend fun getMainPageDramabox(provider: BaseProvider, page: Int, request: MainPageRequest): HomePageResponse {
    ...
    private suspend fun searchDramabox(provider: BaseProvider, query: String): List<SearchResponse> {
        val apiUrl = "https://db.hafizhibnusyam.my.id"
    ...
    private suspend fun loadDramabox(provider: BaseProvider, url: String): LoadResponse {
    ...
    private suspend fun loadLinksDramabox(provider: BaseProvider, data: String, callback: (ExtractorLink) -> Unit): Boolean {
    ...
    private suspend fun getMainPageMelolo(provider: BaseProvider, page: Int, request: MainPageRequest): HomePageResponse {
    ...
    private suspend fun searchMelolo(provider: BaseProvider, query: String): List<SearchResponse> {
        val catalogBase = "https://melolo-api-azure.vercel.app/api/melolo"
    ...
    private suspend fun loadMelolo(provider: BaseProvider, url: String): LoadResponse {
    ...
    private suspend fun loadLinksMelolo(provider: BaseProvider, data: String, callback: (ExtractorLink) -> Unit): Boolean {
    ...
    private suspend fun getMainPageIdlix(provider: BaseProvider, page: Int, request: MainPageRequest): HomePageResponse {
    ...
    private suspend fun searchIdlix(provider: BaseProvider, query: String): List<SearchResponse> {
    ...
    private suspend fun loadIdlix(provider: BaseProvider, url: String): LoadResponse {
    ...
    private suspend fun loadLinksIdlix(provider: BaseProvider, data: String, subtitleCallback: (SubtitleFile) -> Unit, callback: (ExtractorLink) -> Unit): Boolean {
