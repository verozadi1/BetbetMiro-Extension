...
object ProviderMapper {
    ...
    suspend fun ScrapedSearch.toSearchResponse(provider: BaseProvider): SearchResponse {
    ...
    fun ScrapedEpisode.toEpisode(provider: BaseProvider): Episode {
        ...
        return when (type) {
            TvType.Movie -> {
                ...
                provider.pubNewAnimeLoadResponse(title, url, type) {
                    ...
                    this.score = Score.from10(this@toLoadResponse.rating?.toDoubleOrNull())
                    this.recommendations = recommendations
                    val ongoingKeyword = provider.getCached(com.baseprovider.ProviderConstants.STR_ONGOING, "Ongoing")
